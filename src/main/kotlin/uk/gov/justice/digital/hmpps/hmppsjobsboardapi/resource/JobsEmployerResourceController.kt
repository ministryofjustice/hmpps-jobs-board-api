...
class JobsEmployerResourceController(
  ...
  fun getEmployer(): JobEmployerDTO {
    return JobEmployerDTO(
      1, "test", "asdad", "sacintha", Instant.now(), "test", Instant.now(), EmployerWorkSector(1L, 1L, "test", "test"),
      EmployerPartner(1L, EmployerPartnerGrade(1L, 1L, "test", "test"), 1L, "test", "test1"), JobImage(1L, 1L, "ett"), "eh26 0hq",
    )
  }
}
